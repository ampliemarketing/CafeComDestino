...
// recharts fica num chunk à parte, carregado só quando o Dashboard abre (item #17).
      ...
      <Suspense
        fallback={
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 bg-white h-80 rounded-2xl border border-stone-200 shadow-sm animate-pulse" />
            <div className="bg-white h-80 rounded-2xl border border-stone-200 shadow-sm animate-pulse" />
          </div>
        }
      >
        <DashboardCharts
